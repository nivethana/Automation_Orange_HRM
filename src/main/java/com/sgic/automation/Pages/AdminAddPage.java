...
public class AdminAddPage extends PageBase {
    ...
    public static By btnAddCancel=By.id("//*[@id=\"btnCancel\"]");
    ...
    public static void setUsername(String username){
        getDriver().findElement(txtAddEmplname).sendKeys(username);
    }
    ...
    public static void setConformPassword(String Confpassword){
        getDriver().findElement(txtAddPassword).sendKeys(Confpassword);
    }
    ...
    public static void waittillDropDownLoad() {
        waiTillVisible(btnAddSave, 2);
    }
